...
- `Start Automatically`: 사용자 관점의 단일 자동 시작 toggle. 켜면 background helper와 menu bar app을 함께 시작하고 로그인 시 자동 시작되게 함. 끄면 자동 시작 plist를 제거하되 현재 실행 중인 menu app은 종료하지 않음.
